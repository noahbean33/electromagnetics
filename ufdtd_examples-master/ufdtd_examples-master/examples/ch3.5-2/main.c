...
#define E(x)                                                                                                           \
	...
	// This object is different from the one used in ch3.5. It may hold
        // structs with arbitrary number of PetscScalar (degree of freedom or dof)
	DM domain;
